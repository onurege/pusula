 ...
 * Sütunlar: rank, ad, region, ciro, müşteri, fatura, ort sepet, delta vs
 * önceki 30g.
 *
  ...
  return (
    <div className="v3-panel">
          ...
          <tbody>
            {rows.map((r) => (
              <tr key={r.id}>
                ...
                <td className="num">
                  {r.faturaSayi.toLocaleString("tr-TR")}
                </td>
      ...
      <style
        ...
        .v3-table { width: 100%; border-collapse: collapse; font-size: 12.5px; min-width: 760px; }
        ...
        .v3-table td.name { font-weight: 500; max-width: 240px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        .v3-table td.region { color: var(--color-muted); }
