...
export function BrandPortfolioPanel({
  ...
  const stratList = rows.filter((b) => b.isStratejik);
  ...
  return (
    <div className="v3-panel">
      <div className="v3-panel-head">
        <div>
          ...
          <div className="v3-panel-sub">
            Son 30g · Top {visible.length} marka net ciroya göre ·{" "}
            {stratList.length > 0 ? (
              <>
      ...
      <div className="v3-bars">
        {visible.map((b) => (
          <div
            key={b.markaKod || b.marka}
            className={`bar-row ${b.isStratejik ? "strat" : ""}`}
          >
